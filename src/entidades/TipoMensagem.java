...
public enum TipoMensagem {
    ...
    PEDIDO_ABERTURA_CHAT(15),
    DADOS_CHAT_CLIENTE(16),
    ADMIN_INDISPONIVEL(17),
    ADMIN_DISPONIVEL(18),
    NENHUM_ADMIN_DISPONIVEL(19),
    DADOS_CHAT_ADMIN(20),
    MENSAGEM_CLIENTE(21),
    DIRECIONA_MENSAGEM_CLIENTE(22),
    ENCERRAMENTO_CHAT(23),
    AVISA_ENCERRAMENTO_CHAT(24),
    PEDIDO_LOGOUT_CHAT(25),
